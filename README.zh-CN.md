...
[![Java](https://img.shields.io/badge/Java-17-orange)](https://github.com/easy-4-java/pac4j-oauth-ext) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
| 组件 | 版本 | 说明 |
|---|---:|---|
| JDK | 17+ | 由 `maven-enforcer-plugin` 强制校验 |
...
```groovy
implementation 'io.github.easy4j:pac4j-oauth-ext:2.0.x.x.20260630-SNAPSHOT'
```
